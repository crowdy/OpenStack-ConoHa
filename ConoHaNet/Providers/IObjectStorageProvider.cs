namespace ConoHaNet.Providers
{
    ...
    public interface IObjectStorageProvider
    {
        ...
        /// </exception>
        /// <exception cref="net.openstack.Core.Exceptions.ContainerNameException">If <paramref name="container"/> is not a valid container name.</exception>
        /// <exception cref="NotSupportedException">
        /// If the provider does not support the given <paramref name="identity"/> type.
        /// <para>-or-</para>
        /// <para>The specified <paramref name="region"/> is not supported.</para>
        ...
        /// <para>If <paramref name="region"/> is <see langword="null"/> and no default region is available for the provider.</para>
        /// </exception>
        /// <exception cref="net.openstack.Core.Exceptions.ContainerNotEmptyException">If the container could not be deleted because it was not empty and <paramref name="deleteObjects"/> was <see langword="false"/>.</exception>
        /// <exception cref="net.openstack.Core.Exceptions.Response.ItemNotFoundException">If the specified container does not exist.</exception>
        /// <exception cref="net.openstack.Core.Exceptions.Response.ResponseException">If the REST API request failed.</exception>
        ...
        /// <exception cref="net.openstack.Core.Exceptions.ContainerNameException">If <paramref name="container"/> is not a valid container name.</exception>
        /// <exception cref="net.openstack.Core.Exceptions.TTLLengthException">If the provider does not support the specified <paramref name="timeToLive"/>.</exception>
        /// <exception cref="NotSupportedException">
        /// If the provider does not support the given <paramref name="identity"/> type.
        /// <para>-or-</para>
        /// <para>The specified <paramref name="region"/> is not supported.</para>
        ...
        /// </exception>
        /// <exception cref="net.openstack.Core.Exceptions.ContainerNameException">If <paramref name="container"/> is not a valid container name.</exception>
        /// <exception cref="net.openstack.Core.Exceptions.ObjectNameException">
        ...
        /// <para>If <paramref name="region"/> is <see langword="null"/> and no default region is available for the provider.</para>
        /// </exception>
        /// <exception cref="net.openstack.Core.Exceptions.CDNNotEnabledException">If the provider requires containers be CDN-enabled before they can be accessed from the web, and the <see cref="ContainerCDN.CDNEnabled"/> property is false.</exception>
        /// <exception cref="net.openstack.Core.Exceptions.Response.ResponseException">If the REST API request failed.</exception>
        ...
        /// </exception>
        /// <exception cref="net.openstack.Core.Exceptions.ContainerNameException">If <paramref name="container"/> is not a valid container name.</exception>
        /// <exception cref="net.openstack.Core.Exceptions.ObjectNameException">If <paramref name="css"/> is not a valid object name.</exception>
        /// <exception cref="NotSupportedException">
        /// If the provider does not support the given <paramref name="identity"/> type.
        /// <para>-or-</para>
        /// <para>The specified <paramref name="region"/> is not supported.</para>
        ...
        /// </exception>
        /// <exception cref="net.openstack.Core.Exceptions.ContainerNameException">If <paramref name="container"/> is not a valid container name.</exception>
        /// <exception cref="net.openstack.Core.Exceptions.ObjectNameException">If <paramref name="objectName"/> is not a valid object name.</exception>
        /// <exception cref="NotSupportedException">
        /// If the provider does not support the given <paramref name="identity"/> type.
        /// <para>-or-</para>
        /// <para>The specified <paramref name="region"/> is not supported.</para>
        ...
        /// <para>If <paramref name="headers"/> contains two equivalent keys when compared using <see cref="StringComparer.OrdinalIgnoreCase"/>.</para>
        /// </exception>
        /// <exception cref="net.openstack.Core.Exceptions.ContainerNameException">
        ...
        /// <para>If <paramref name="region"/> is <see langword="null"/> and no default region is available for the provider.</para>
        /// </exception>
        /// <exception cref="net.openstack.Core.Exceptions.CDNNotEnabledException">If the specified <paramref name="container"/> is not CDN-enabled.</exception>
        /// <exception cref="net.openstack.Core.Exceptions.Response.ResponseException">If the REST API request failed.</exception>
        ...
        /// <inheritdoc/>
        void UpdateAccountMetadata(Dictionary<string, string> metadata, string tenantId, string region = null, bool useInternalUrl = false, CloudIdentity identity = null);
