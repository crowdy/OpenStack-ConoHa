...
#pragma warning disable 649 // Field 'fieldName' is never assigned to, and will always have its default value {value}
        ...
        private IEnumerable<MediaType> _mediaTypes;

        /// <summary>
        /// This is the backing field for the <see cref="Links"/> property.
        /// <see href="https://github.com/DotNetAnalyzers/StyleCopAnalyzers/pull/1506/"/>
        /// <see href="https://github.com/JamesNK/Newtonsoft.Json/issues/652"/>
        /// </summary>
...
#pragma warning restore 649
        ...
        public ImmutableArray<MediaType> MediaTypes
        {
            get
            {
                return _mediaTypes.ToImmutableArray<MediaType>();
            }
        }
        ...
        public ImmutableArray<Link> Links
        {
            get
            {
                return _links.ToImmutableArray<Link>();
            }
        }
    }
}
