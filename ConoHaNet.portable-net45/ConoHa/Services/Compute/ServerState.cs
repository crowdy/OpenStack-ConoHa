namespace ConoHaNet.Services.Compute
{
    ...
    public sealed class ServerState : ExtensibleEnum<ServerState>
    {
        ...
        private static readonly ServerState _shutoff = FromName("SHUTOFF");
        ...
        /// <summary>
        /// Gets a <see cref="ServerState"/> representing a server which is currently being shutdowned.
        /// </summary>
        public static ServerState ShutOff
        {
            get
            {
                return _shutoff;
