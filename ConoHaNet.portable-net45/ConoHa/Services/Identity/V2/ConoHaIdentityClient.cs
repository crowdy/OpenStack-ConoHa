namespace Rackspace.Services.Identity.V2
{
    ...
    /// <preliminary/>
    public class ConoHaIdentityClient : IdentityClient
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConoHaIdentityClient"/> class with the specified fixed base address.
        /// </summary>
        ...
        /// </exception>
        public ConoHaIdentityClient(Uri baseAddress)
            : base(baseAddress)
        {
        }
        ...
        /// If <paramref name="baseAddress"/> is not an absolute URI.
        /// </exception>
        public ConoHaIdentityClient(IAuthenticationService authenticationService, Uri baseAddress)
